...
const canEditSettings = computed(() => useAuthStore().isSuperAdmin)
...
const blogForm = ref({
  ...
  about_describe: '',
  about_describe_tips: '',
  about_guestbook_title: '留言簿',
  about_guestbook_description: '来都来了，\n留句话再走吧。\n一个 👋 也可以。',
  about_guestbook_transition: '如果你愿意，\n留一句话再继续往下看。',
  about_guestbook_empty_text: '还没有留言，来说点什么吧。',
  about_exhibition: '',
  about_model_enabled: true,
  about_model_url: '/models/cat/scene.gltf',
  about_model_credit: '3D model: Cute Cat in Cute Banana by SOBOL, licensed under CC-BY-4.0',
  about_model_rotate: true,
  about_model_control: true,
  about_model_zoom: false,
...
const loadBlogConfigs = async () => {
  try {
    ...
    Object.assign(blogForm.value, {
      ...
      about_guestbook_title: configs.about_guestbook_title || '留言簿',
      about_guestbook_description: configs.about_guestbook_description || '来都来了，\n留句话再走吧。\n一个 👋 也可以。',
      about_guestbook_transition: configs.about_guestbook_transition || '如果你愿意，\n留一句话再继续往下看。',
      about_guestbook_empty_text: configs.about_guestbook_empty_text || '还没有留言，来说点什么吧。',
      about_exhibition: configs.about_exhibition || '',
      about_model_enabled: configs.about_model_enabled !== 'false',
      about_model_url: configs.about_model_url || '/models/cat/scene.gltf',
      about_model_credit: configs.about_model_credit || '',
      about_model_rotate: configs.about_model_rotate !== 'false',
      about_model_control: configs.about_model_control !== 'false',
      about_model_zoom: configs.about_model_zoom === 'true',
...
const handleSave = async () => {
  ...
  try {
    ...
    const blogPayload: Record<string, string> = {
      ...
      'blog.about_guestbook_title': blogForm.value.about_guestbook_title,
      'blog.about_guestbook_description': blogForm.value.about_guestbook_description,
      'blog.about_guestbook_transition': blogForm.value.about_guestbook_transition,
      'blog.about_guestbook_empty_text': blogForm.value.about_guestbook_empty_text,
      'blog.about_exhibition': blogForm.value.about_exhibition,
      'blog.about_model_enabled': blogForm.value.about_model_enabled ? 'true' : 'false',
      'blog.about_model_url': blogForm.value.about_model_url,
      'blog.about_model_credit': blogForm.value.about_model_credit,
      'blog.about_model_rotate': blogForm.value.about_model_rotate ? 'true' : 'false',
      'blog.about_model_control': blogForm.value.about_model_control ? 'true' : 'false',
      'blog.about_model_zoom': blogForm.value.about_model_zoom ? 'true' : 'false',
